// frmRockPaperScissors.cs, RockPaperScissors.sln
// CS 1181
// Katherine Wilsdon
// 13 October 2018
// Dr. Cody Permann
/* Description - Create a rock, paper scissors game. The user picks a one player game, two players game, or an automatic game.
 * For the one player game, the player chooses rock, paper, or scissors and the computer will randomly roll and the program
 * calculates who wins. For the two players game, both players pick rock, paper, or scissors and the program determines who wins
 * For the computer vs. computer game, the user sets a number of games between 10 and 10,000 on the trackbar and the program randomizes  
 * the rolls and calculates to total wins. The output is the total win statistics for player 1, player 2, and the ties */
// WOW: Created a player vs. player game
/* Cited:
 * Clicks the clear button with the TabPage changes: https://stackoverflow.com/questions/14374264/changing-a-tab-and-clearing-content 
 ...
 * Book, Chapters 5, 6, and 8: Gaddis, T. (2017). Starting out with Visual C# (4th ed.). Boston, PA: Pearson.*/
using System;
    ...
    public partial class frmRockPaperScissors : Form {
        ...
        private void Throw() {
            ...
            if (player1WinsTotal > player2WinsTotal) {
                lblWhoWonStatistics.Text = "Player 1 Wins!\r\n" + "Won " + player1WinsTotal.ToString("n0") + 
                    " / " + gamesPlayed.ToString("n0");
            } else if (player2WinsTotal > player1WinsTotal) {
                lblWhoWonStatistics.Text = "Player 2 Wins!\r\n" + "Won " + player2WinsTotal.ToString("n0") + 
                    " / " + gamesPlayed.ToString("n0");
            } else if (player1WinsTotal == player2WinsTotal) {
                lblWhoWonStatistics.Text = "There is a tie!\r\nPlay one more game\r\nto determine who wins." + 
        ...
        private void Throw(int player1Throw) {
            ...
            if (didPlayer1Win) {
                player1WinsTotal += 1;
                lblWhoWonStatistics.Text = "Player 1 threw " + (Rolls)player1Roll + ".\r\nPlayer 2 threw " + 
                    (Rolls)player2Roll + ".\r\nPlayer 1 Wins!\r\n" + "Won " + player1WinsTotal.ToString("n0") + 
                    " / " + gamesPlayed.ToString("n0");
